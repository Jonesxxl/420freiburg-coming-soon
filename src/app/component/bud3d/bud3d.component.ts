...
@Component({
  ...
  standalone: true,
  imports: [],
  templateUrl: './bud3d.component.html',
  styleUrls: ['./bud3d.component.css']
})
export class Bud3dComponent implements OnInit, AfterViewInit {
  @ViewChild('canvas')
  ...
  private createScene() {
    ...
    this.loaderGLTF.load('assets/weed_nugget_1/scene.gltf', (gltf: GLTF) => {
 ...
 */
  private startRenderingLoop() {
    ...
    let component: Bud3dComponent = this;
    (function render() {
